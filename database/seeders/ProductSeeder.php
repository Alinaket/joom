...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            ...
            ['img'=>"https://img.joomcdn.net/c7f3606bc667ac5faa5e7cda876d065fb8eadc4c_original.jpeg", 'sale'=>"53",'price'=>"744", 'price_sale'=>"323", 'star'=>"4.6",'name'=>"Літній гонконгський стиль Половина C з короткими рукавами квіткова сорочка",],
            ['img'=>"https://img.joomcdn.net/4ffa3c3ed8c3f617925fc2d586f58d8dd7cc03fa_original.jpeg", 'sale'=>"60",'price'=>"1 845", 'price_sale'=>"738", 'star'=>"4,5",'name'=>"Полотняні туфлі чоловіче літо Класичні лофери чоловіки повсякденне взуття",],
            ['img'=>"https://img.joomcdn.net/d7b39078ec119672ebda23eba7a67e703046f52b_original.jpeg", 'sale'=>"52",'price'=>"1 064", 'price_sale'=>"512", 'star'=>"",'name'=>"ZIRUNKING хіп-хоп негабаритні футболки Unisex 2021 Вуличний одяг Хараджуку Випадковий Unisex Tshirt",],
            ['img'=>"https://img.joomcdn.net/33e39cb24f8798e80683b5dd66057d62631c54f8_original.jpeg", 'sale'=>"62",'price'=>"2 040", 'price_sale'=>"782", 'star'=>"4.5",'name'=>"Літо Плюс розмір чоловічі широкі штани з декількома кишенями комбінезони прямі випадкові штани відкритий",],
            ['img'=>"https://img.joomcdn.net/33e39cb24f8798e80683b5dd66057d62631c54f8_original.jpeg", 'sale'=>"62",'price'=>"2 040", 'price_sale'=>"782", 'star'=>"4.5",'name'=>"Літо Плюс розмір чоловічі широкі штани з декількома кишенями комбінезони прямі випадкові штани відкритий",],
            ['img'=>"https://img.joomcdn.net/57c1abe227f82568c2e354ef2894ab889291e5c2_original.jpeg", 'sale'=>"60",'price'=>"3 157,50", 'price_sale'=>"1 263", 'star'=>"4.2",'name'=>"Куртка чоловіча пальто плюс розмір жир повсякденна підставка комір чоловіча куртка М -8хл",],
