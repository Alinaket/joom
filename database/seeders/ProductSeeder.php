...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
            ...
            ['category'=>1, 'img'=>"https://img.joomcdn.net/6c0ccc2a55c87e044ade226aa7aab894cbfbf73e_original.jpeg", 'sale'=>35,'price'=>2070, 'price_sale'=>1340, 'star'=>"4.8",'name'=>"PC Ігрова гарнітура дівчата Рожеве котяче вухо Дротові стерео",],
