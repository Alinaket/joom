...
<div class="header">
    <div class="logo">
        <a href="{{route("profile.joom")}}"><img
                src="https://logovectordl.com/wp-content/uploads/2019/11/joom-logo-vector.png" alt=""></a>
    </div>
    <div class="box_input">
        <div class="input">
            <form>
    ...
    <div class="users">
        <ul>
            <li><a href="#"><span><i class="fa-solid fa-bell"></i></span>Сповіщення</a> <span
                    class="message">1</span>
            </li>
            ...
            <li><a href="{{route("profile.cart")}}"><span><i class="fa-solid fa-cart-shopping"></i></span>Кошик</a>
            </li>
        </ul>
    </div>
</div>
<div class="categories">
    <ul>
        ...
        <li class="reviews_users"><span><i class="fa-regular fa-window-restore"></i></span>Огляди від користувачів
        </li>
        <li>Жіноча мода</li>
        <li>Електроніка</li>
