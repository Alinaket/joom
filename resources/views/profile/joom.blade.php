...
<div class="content">
    <div class="banner">
        ...
        <div class="cardList">
            <div class="card blue">
                <div class="text">
                    <h3>Товари з високим рейтенгом</h3>
                    <p>Муркотливі знижки</p>
                </div>
                <div class="img">
                    <img src="https://upload.joomcdn.net/71cd39c5de69274fa644d5548f81435e11db4e29_original.png" alt="">
                </div>
            </div>
            <div class="card pink">
                <div class="text">
